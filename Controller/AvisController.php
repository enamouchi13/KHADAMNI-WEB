...
/*
    ...
    #[Route('/{id}', name: 'app_avis_show', methods: ['GET'])]
        public function show(Avis $avi): Response
        {
            $avis = $this->getDoctrine()->getRepository(Avis::class)->find($avi->getId()); // Récupérer l'avis à partir de l'objet Avis passé en paramètre
            $user = $avis->getUser(); // Récupérer l'objet utilisateur associé à l'avis
            $userId = $user->getId(); // Récupérer l'ID de l'utilisateur associé à l'avis
        
            return $this->render('avis/show.html.twig', [
                'avi' => $avi,
                'user_id' => $userId, // Passer l'ID de l'utilisateur à la vue
            ]);
        }
