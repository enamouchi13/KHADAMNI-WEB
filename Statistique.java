...
//CODE TEMPLATE :
    ...
    private double nbr_utilisateur = 29;
        ...
        RadioButton popular = RadioButton.createToggle("Categorie utilisateur", barGroup);
 ...
 // **********************partie statistics eli hachty beha *******************************   
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_feedback + nbr_utilisateur;
        
        //values
        double prcntFeed = (nbr_feedback *100)/total;
        
        double prcntRec = (nbr_utilisateur * 100)/total;
        ...
        String []messages = {
            "Statistique feedback % utilisateur"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("utilisateur",prcntRec);
